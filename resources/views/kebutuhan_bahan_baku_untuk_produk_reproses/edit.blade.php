...
@section('title')
    Edit {{ ucReplaceUnderscoreToSpace('kebutuhan_bahan_baku_untuk_produk_reproses') }}
@endsection
...
@section('navigation')
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a href="{{ route('kbbupr.edit', $kebutuhan_bahan_baku_untuk_produk_reproses[0]->id) }}">@yield('title')</a>
        </li>
    </ul>
@endsection
...
@section('content')
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('kbbupr.update', $id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="produk_reproses form-control" id="produk_reproses_id" name="produk_reproses_id" required>
                                                ...
                                                @foreach ($produk_reprosess as $produk_reproses)
                                                    <option value="{{ $produk_reproses->id }}" {{ $produk_reproses->id == $kebutuhan_bahan_baku_untuk_produk_reproses[0]->produk_reproses_id ? 'selected' : '' }}>
    ...
    <script>
        $(document).ready(function() {
            ...
            let bahan_bakuCounter = {{ count($kebutuhan_bahan_baku_untuk_produk_reproses) }};
