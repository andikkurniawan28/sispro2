...
@section('title')
    Detail {{ ucReplaceUnderscoreToSpace('pemasukan_gudang') }}
@endsection
                    ...
                    <div class="card" id="invoice-section">
                        <div class="card-body">
                            <div class="invoice-header">
                                <h4 class="invoice-title">Faktur {{ ucReplaceUnderscoreToSpace('pemasukan_gudang') }}</h4>
                                <div class="invoice-info">
                                    <div>
                                        <strong>Kode:</strong> {{ $pemasukan_gudang->kode }}
                                    </div>
                                    <div>
                                        <strong>Dibuat pada:</strong>
                                        {{ date('d-m-Y H:i:s', strtotime($pemasukan_gudang->created_at)) }}
                                    </div>
                                    <div>
                                        <strong>Gudang:</strong>
                                        {{ $pemasukan_gudang->gudang->nama }}
                                    </div>
                                    <div>
                                        <strong>Dicatat Oleh:</strong> {{ $pemasukan_gudang->user->nama }}
                                        ({{ $pemasukan_gudang->user->jabatan->nama }})
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="invoice-body">
                                <h5>Detail {{ ucReplaceUnderscoreToSpace('pemasukan_gudang') }}:</h5>
                                <br>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($pemasukan_gudang_detail as $index => $material)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>{{ formatRupiah($pemasukan_gudang->grand_total) }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
        ...
        function exportToPDF() {
            ...
            html2pdf()
                ...
                .set({
                    ...
                    filename: "Faktur {{ ucReplaceUnderscoreToSpace('pemasukan_gudang') }}.pdf",
