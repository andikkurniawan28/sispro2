...
@section('title')
    Detail {{ ucReplaceUnderscoreToSpace('penyesuaian_gudang') }}
@endsection
                    ...
                    <div class="card" id="invoice-section">
                        <div class="card-body">
                            <div class="invoice-header">
                                <h4 class="invoice-title">Faktur {{ ucReplaceUnderscoreToSpace('penyesuaian_gudang') }}</h4>
                                <div class="invoice-info">
                                    <div>
                                        <strong>Kode:</strong> {{ $penyesuaian_gudang->kode }}
                                    </div>
                                    <div>
                                        <strong>Jenis:</strong> {{ $penyesuaian_gudang->jenis_penyesuaian_gudang->nama }}
                                    </div>
                                    <div>
                                        <strong>Dibuat pada:</strong>
                                        {{ date('d-m-Y H:i:s', strtotime($penyesuaian_gudang->created_at)) }}
                                    </div>
                                    <div>
                                        <strong>Gudang:</strong>
                                        {{ $penyesuaian_gudang->gudang->nama }}
                                    </div>
                                    <div>
                                        <strong>Dicatat Oleh:</strong> {{ $penyesuaian_gudang->user->nama }}
                                        ({{ $penyesuaian_gudang->user->jabatan->nama }})
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="invoice-body">
                                <h5>Detail {{ ucReplaceUnderscoreToSpace('penyesuaian_gudang') }}:</h5>
                                <br>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($penyesuaian_gudang_detail as $index => $material)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>{{ formatRupiah($penyesuaian_gudang->grand_total) }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
        ...
        function exportToPDF() {
            ...
            html2pdf()
                ...
                .set({
                    ...
                    filename: "Faktur {{ ucReplaceUnderscoreToSpace('penyesuaian_gudang') }}.pdf",
