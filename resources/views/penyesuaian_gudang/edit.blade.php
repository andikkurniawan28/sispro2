                                                        ...
                                                        <tr id="material_row_{{ $index }}">
                                                                ...
                                                                <select class="material form-control"
                                                                    ...
                                                                    @foreach ($materials as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            {{ $penyesuaian_gudang->material_id == $item->id ? 'selected' : '' }}
                                                            ...
                                                            <td>
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ $penyesuaian_gudang->jumlah_dalam_satuan_kecil }}"
                                                                    step="any" required>
                                                                <span id="satuan_kecil_{{ $index }}"
                                                                    class="satuan_kecil">{{ $penyesuaian_gudang->material->satuan_kecil->nama }}</span>
                                                            </td>
                                                            <td>
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ $penyesuaian_gudang->jumlah_dalam_satuan_besar }}"
                                                                    step="any">
                                                                <span id="satuan_besar_{{ $index }}"
                                                                    class="satuan_besar">{{ $penyesuaian_gudang->material->satuan_besar->nama }}</span>
                                                            </td>
                                                            <td>
                                                                <input type="number" class="form-control harga" id="harga_{{ $index }}" name="harga[]" placeholder="Masukkan {{ ucReplaceUnderscoreToSpace('harga') }}" value="{{ $penyesuaian_gudang->harga }}" step="any" required>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control total" id="total_{{ $index }}" name="total[]" value="{{ $penyesuaian_gudang->total }}" readonly>
                                                                <span class="total_span" id="total_span_{{ $index }}">{{ formatRupiah($penyesuaian_gudang->total) }}</span>
                                                            </td>
                                                            <td>
                                                                <button type="button"
    ...
    <script>
        ...
        $(document).ready(function() {
            function initializeSelect2() {
                $('.jenis_penyesuaian_gudang').select2({
                    theme: 'bootstrap',
                    width: '100%',
                });
                $('.gudang').select2({
