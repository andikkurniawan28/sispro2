...
@section('title')
    Tambah {{ ucReplaceUnderscoreToSpace('penyesuaian_gudang') }}
@endsection
...
@section('content')
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('penyesuaian_gudang.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="jenis_penyesuaian_gudang form-control @error('jenis_penyesuaian_gudang_id') is-invalid @enderror"
                                                id="jenis_penyesuaian_gudang_id" name="jenis_penyesuaian_gudang_id" required>
                                                <option disabled selected>Pilih {{ ucReplaceUnderscoreToSpace('jenis_penyesuaian_gudang') }}
                                                </option>
                                                @foreach ($jenis_penyesuaian_gudangs as $jenis_penyesuaian_gudang)
                                                    <option value="{{ $jenis_penyesuaian_gudang->id }}" data-kode-jurnal-gudang="{{ $jenis_penyesuaian_gudang->kode }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.jenis_penyesuaian_gudang', function() {
                updateKode($(this));
            });
