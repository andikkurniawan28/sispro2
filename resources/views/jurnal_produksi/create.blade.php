...
@section('title')
    Tambah {{ ucReplaceUnderscoreToSpace('jurnal_produksi') }}
@endsection
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('jurnal_produksi.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="permintaan form-control @error('permintaan_id') is-invalid @enderror"
                                                id="permintaan_id" name="permintaan_id" required>
                                                <option disabled selected>Pilih {{ ucReplaceUnderscoreToSpace('permintaan') }}
                                                </option>
                                                @foreach ($permintaans as $permintaan)
                                                    <option value="{{ $permintaan->id }}"
                                                        {{ old('permintaan_id') == $permintaan->id ? 'selected' : '' }}>
                                                        {{ ucwords(str_replace('_', ' ', $permintaan->kode)) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('permintaan_id')
