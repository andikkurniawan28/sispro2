...
@section('title')
    Edit {{ ucReplaceUnderscoreToSpace('bahan_baku') }}
@endsection
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kode" name="kode"
                                                value="{{ $bahan_baku->kode }}" placeholder="Masukkan kode ..." required
                                                autofocus>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">{{ ucReplaceUnderscoreToSpace('nama') }}</label>
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                value="{{ $bahan_baku->nama }}" placeholder="Masukkan nama ..." required>
                                        </div>
                                        <div class="form-group">
                                            <label
                                            ...
                                            <select class="form-control jenis_bahan_baku_id" id="jenis_bahan_baku_id"
                                                ...
                                                @foreach ($jenis_bahan_bakus as $jenis_bahan_baku)
                                                    <option value="{{ $jenis_bahan_baku->id }}"
                                                        @if ($bahan_baku->jenis_bahan_baku_id == $jenis_bahan_baku->id) selected @endif>{{ $jenis_bahan_baku->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <select class="form-control satuan_besar_id" id="satuan_besar_id"
                                                ...
                                                @foreach ($satuans as $satuan)
                                                    <option value="{{ $satuan->id }}"
                                                        @if ($bahan_baku->satuan_besar_id == $satuan->id) selected @endif>{{ $satuan->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="sejumlah" name="sejumlah"
                                                value="{{ $bahan_baku->sejumlah }}" placeholder="Dalam 1 satuan besar mengandung sejumlah xxx satuan kecil ..." step="any" required>
                                        </div>
                                        <div class="form-group">
                                            <label
                                            ...
                                            <select class="form-control satuan_kecil_id" id="satuan_kecil_id"
                                                ...
                                                @foreach ($satuans as $satuan)
                                                    <option value="{{ $satuan->id }}"
                                                        @if ($bahan_baku->satuan_kecil_id == $satuan->id) selected @endif>{{ $satuan->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
