...
@section('title')
    Tambah {{ ucReplaceUnderscoreToSpace('kebutuhan_bahan_baku_untuk_produk_akhir') }}
@endsection
...
@section('navigation')
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a
                href="{{ route('kbbupa.index') }}">{{ ucReplaceUnderscoreToSpace('kebutuhan_bahan_baku_untuk_produk_akhir') }}</a>
        </li>
        <li class="separator">
            <i class="icon-arrow-right"></i>
        </li>
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('kbbupa.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
