...
@section('title')
    Tambah {{ ucReplaceUnderscoreToSpace('mutasi_antar_gudang') }}
@endsection
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('mutasi_antar_gudang.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <select class="jenis_mutasi_antar_gudang form-control @error('jenis_mutasi_antar_gudang_id') is-invalid @enderror"
                                                id="jenis_mutasi_antar_gudang_id" name="jenis_mutasi_antar_gudang_id" required>
                                                <option disabled selected>Pilih {{ ucReplaceUnderscoreToSpace('jenis_mutasi_antar_gudang') }}
                                                </option>
                                                @foreach ($jenis_mutasi_antar_gudangs as $jenis_mutasi_antar_gudang)
                                                    <option value="{{ $jenis_mutasi_antar_gudang->id }}" data-kode-jurnal-gudang="{{ $jenis_mutasi_antar_gudang->kode }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="gudang form-control @error('gudang_asal_id') is-invalid @enderror"
                                                id="gudang_asal_id" name="gudang_asal_id" required>
                                                <option disabled selected>Pilih {{ ucReplaceUnderscoreToSpace('gudang_asal') }}
                                                </option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="gudang form-control @error('gudang_tujuan_id') is-invalid @enderror"
                                                id="gudang_tujuan_id" name="gudang_tujuan_id" required>
                                                <option disabled selected>Pilih {{ ucReplaceUnderscoreToSpace('gudang_tujuan') }}
                                                </option>
                                                @foreach ($gudangs as $gudang)
                                                    <option value="{{ $gudang->id }}"
    ...
    <script>
        $(document).ready(function() {
            function initializeSelect2() {
                $('.jenis_mutasi_antar_gudang').select2({
                    theme: 'bootstrap',
                    width: '100%',
                });
                $('.gudang').select2({
            ...
            $(document).on('change', '.jenis_mutasi_antar_gudang', function() {
                updateKode($(this));
            });
