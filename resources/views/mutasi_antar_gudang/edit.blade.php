                                            ...
                                            <select class="gudang form-control @error('gudang_asal_id') is-invalid @enderror"
                                                ...
                                                @foreach ($gudangs as $gudang)
                                                    <option value="{{ $gudang->id }}"
                                                        {{ $data->gudang_asal_id == $gudang->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="gudang form-control @error('gudang_tujuan_id') is-invalid @enderror"
                                                ...
                                                @foreach ($gudangs as $gudang)
                                                    <option value="{{ $gudang->id }}"
                                                        {{ $data->gudang_tujuan_id == $gudang->id ? 'selected' : '' }}>
                                                        {{ ucwords(str_replace('_', ' ', $gudang->nama)) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                                        ...
                                                        <tr id="material_row_{{ $index }}">
                                                                ...
                                                                <select class="material form-control"
                                                                    ...
                                                                    @foreach ($materials as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            {{ $mutasi_antar_gudang->material_id == $item->id ? 'selected' : '' }}
                                                            ...
                                                            <td>
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ $mutasi_antar_gudang->jumlah_dalam_satuan_kecil }}"
                                                                    step="any" required>
                                                                <span id="satuan_kecil_{{ $index }}"
                                                                    class="satuan_kecil">{{ $mutasi_antar_gudang->material->satuan_kecil->nama }}</span>
                                                            </td>
                                                            <td>
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ $mutasi_antar_gudang->jumlah_dalam_satuan_besar }}"
                                                                    step="any">
                                                                <span id="satuan_besar_{{ $index }}"
                                                                    class="satuan_besar">{{ $mutasi_antar_gudang->material->satuan_besar->nama }}</span>
                                                            </td>
                                                            <td>
                                                                <input type="number" class="form-control harga" id="harga_{{ $index }}" name="harga[]" placeholder="Masukkan {{ ucReplaceUnderscoreToSpace('harga') }}" value="{{ $mutasi_antar_gudang->harga }}" step="any" required>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control total" id="total_{{ $index }}" name="total[]" value="{{ $mutasi_antar_gudang->total }}" readonly>
                                                                <span class="total_span" id="total_span_{{ $index }}">{{ formatRupiah($mutasi_antar_gudang->total) }}</span>
                                                            </td>
                                                            <td>
                                                                <button type="button"
