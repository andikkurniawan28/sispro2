...
@section('title')
    Edit {{ ucReplaceUnderscoreToSpace('permintaan_produk_reproses') }}
@endsection
...
@section('content')
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('permintaan_produk_reproses.update', $permintaan_produk_reproses->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kode" name="kode"
                                                value="{{ old('kode', $permintaan_produk_reproses->kode) }}" placeholder="Masukkan kode ..." readonly>
                                        </div>
                                        <div class="form-group">
                                            <label
                                            ...
                                            <input type="datetime-local" class="form-control" id="berlaku_sampai"
                                                name="berlaku_sampai" value="{{ old('berlaku_sampai', $permintaan_produk_reproses->berlaku_sampai) }}"
                                    ...
                                    <div class="col-md-8">
                                        <div id="produk_reproses_container">
                                            @if (old('produk_reproses', $permintaan_produk_reproses_detail ))
                                                @foreach (old('produk_reproses', $permintaan_produk_reproses_detail ) as $index => $produk_reproses)
                                                    <div class="row mb-3" id="produk_reproses_row_{{ $index }}">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <select class="produk_reproses form-control" id="produk_reproses_{{ $index }}" name="produk_reproses[]" required>
                                                                ...
                                                                @foreach ($produk_reproses as $produk_reprosesItem)
                                                                    <option value="{{ $produk_reprosesItem->id }}" {{ $produk_reprosesItem->id == $produk_reproses->produk_reproses_id ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <input type="number" class="form-control jumlah" id="jumlah_{{ $index }}" name="jumlahs[]" placeholder="Masukkan {{ ucReplaceUnderscoreToSpace('jumlah') }}" value="{{ old('jumlahs')[$index] ?? $produk_reproses->jumlah }}" required>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            ...
                                                            <span class="satuan_besar_nama form-control" id="satuan_besar_nama_{{ $index }}">
                                                                {{ $produk_reproses->find($produk_reproses->produk_reproses_id)->satuan_besar->nama }}
                                                            </span>
                                                        </div>
                                                        <div class="col-sm-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            let produk_reprosesCounter = {{ old('produk_reproses', $permintaan_produk_reproses_detail ) ? count(old('produk_reproses', $permintaan_produk_reproses_detail )) : 0 }};
