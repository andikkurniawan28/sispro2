...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <select class="jenis_pengeluaran_gudang form-control @error('jenis_pengeluaran_gudang_id') is-invalid @enderror"
                                                id="jenis_pengeluaran_gudang_id" name="jenis_pengeluaran_gudang_id" required>
                                                <option disabled selected>Pilih {{ ucReplaceUnderscoreToSpace('jenis_pengeluaran_gudang') }}
                                                </option>
                                                @foreach ($jenis_pengeluaran_gudangs as $jenis_pengeluaran_gudang)
                                                    <option value="{{ $jenis_pengeluaran_gudang->id }}" data-kode-jurnal-gudang="{{ $jenis_pengeluaran_gudang->kode }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.jenis_pengeluaran_gudang', function() {
                updateKode($(this));
            });
